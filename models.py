...
class TestAppTestmodel(models.Model):
    model_id = models.CharField(db_column='model_ID', max_length=12)  # Field name made lowercase.
    model_name = models.CharField(db_column='model_NAME', max_length=20)  # Field name made lowercase.
    model_password = models.CharField(db_column='model_PASSWORD', max_length=32)  # Field name made lowercase.
